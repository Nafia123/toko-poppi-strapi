...
body {font-family: 'Lato', sans-serif;}
    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="99" alt="" data-proportionally-constrained="true" data-responsive="false" src="http://cdn.mcauto-images-production.sendgrid.net/9577ec0bd491d43d/cf78b318-5b70-4f7e-93dc-099b3fc76f9c/213x257.png" height="119">
        </td>
      </tr>
    </tbody>
  </table></td>
  ...
  <% _.forEach(orderContent, function(order) { %>

  <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:30px 30px 20px 30px;" bgcolor="#f6fcff" data-distribution="1,1">
    <tbody>
      <tr role="module-content">
    ...
    <tbody>
      <tr>
        <td style="padding:20px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><strong><%- order.name %></strong></div>
<div style="font-family: inherit; text-align: inherit"><br></div>
<div style="font-family: inherit; text-align: inherit">Side dishes:</div>

 <% _.forEach(order.option, function(option) { %>
<div style="font-family: inherit; text-align: inherit; margin-bottom: 10px"><%- option %></div>
  <% }); %>

<div style="font-family: inherit; text-align: inherit">Price: €<%- order.price.toFixed(2) %></div>
<div style="font-family: inherit; text-align: inherit">Qty: <%- order.amount %></div>
<div style="font-family: inherit; text-align: inherit">Total: €<%- (order.price * order.amount).toFixed(2) %></div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
        </tr>
 ...
 <table class="module" role="module" data-type="spacer" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="10dfe38b-ab1a-4083-80ca-725cb09e3c1c">
    ...
    <tbody>
      <tr>
<div style="font-family: inherit; text-align: inherit; margin-left: 10%"><strong>Total: €<%= paymentAmount.toFixed(2) %></strong></div><div></div></div></td>
      </tr>
    </tbody>
